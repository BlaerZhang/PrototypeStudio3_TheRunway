Shader "Unreal/MI_Luggage_Clean"
{
    Properties
    {
		...
		Material_Texture2D_0( "Normals", 2D ) = "white" {}
		Material_Texture2D_1( "Albedo", 2D ) = "white" {}
		Material_Texture2D_2( "Albedo Mask", 2D ) = "white" {}
		Material_Texture2D_3( "AORM", 2D ) = "white" {}
		Material_Texture2D_4( "T_PlasticDetail_BC", 2D ) = "white" {}
